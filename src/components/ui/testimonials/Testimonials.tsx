...
function Testimonials() {
    return (
        <section className="relative mx-auto flex flex-col justify-center items-center">
            <video
                autoPlay
                muted
                loop
                className="absolute md:top-0 md:h-full md:w-full w-screen h-screen left-0 right-0 z-[1] object-cover"
            >
            ...
            <div className="max-w-6xl px-6 py-10 mx-auto bg-transparent">
                ...
                <main className="relative z-20 w-full mt-8 md:flex md:items-center xl:mt-12">
                    <div className="absolute w-full bg-stone-950/40 -z-10 md:h-96 rounded-2xl"></div>
